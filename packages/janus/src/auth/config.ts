...
interface SharedConfig {
	 ...
	 * `user.passwordReset`, `user.deleted` — once the write landed, and
	 * awaited before the flow answers. `webhooks({ … })` from
	 * `@nxgt/janus-webhooks` signs and delivers them; any function will do.
	 */
