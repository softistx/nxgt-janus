# @nxgt/janus-telemetry — documentation

The [README](../README.md) lists every span and event; these pages give the
detail.

| Page | Read it when |
| --- | --- |
| [Tracing Janus](guide/tracing.md) | You are wiring it into an application, reading what it wrote, or following a sign-in with a second factor or an e-mailed code |
...
The words — user, session, object, permission, refusal, failure — are
